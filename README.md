...
The model consists of encoder-decoder architecture inspired by [a relative link](High Quality Monocular Depth Estimation via Transfer Learning
https://arxiv.org/abs/1812.11941) but trained with different and input modality and loss functions.
